...
firebase = firebase.FirebaseApplication("https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js", None)
login_window = Tk()
...
def getData():
    ...
    if(get_friends_data != None):
        ...
        original = decrypt('AIM', byte_str)
        final_message = original.deconde("utf-8")
